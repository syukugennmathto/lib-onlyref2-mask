...
#define int_masking_boolean_refresh DILITHIUM_NAMESPACE(int_masking_boolean_refresh)
void int_masking_boolean_refresh(int32_t* pC, int32_t *pA,pMsm pMsx);

#define int_masking_boolean_fullrefresh DILITHIUM_NAMESPACE(int_masking_boolean_fullrefresh)
void int_masking_boolean_fullrefresh(int32_t* pC, int32_t *pA);

#define int_masking_boolean_fullxor DILITHIUM_NAMESPACE(int_masking_boolean_fullxor)
int32_t int_masking_boolean_fullxor(int32_t* pA);

#define int_masking_boolean_generate DILITHIUM_NAMESPACE(int_masking_boolean_generate)
void int_masking_boolean_generate(int32_t* pC,int32_t a,svec *pVa);

#define int_masking_boolean_xor DILITHIUM_NAMESPACE(int_masking_boolean_xor)
void int_masking_boolean_xor(int32_t* pC, int32_t *pA, int32_t *pB);

#define int_masking_boolean_neg DILITHIUM_NAMESPACE(int_masking_boolean_neg)
void int_masking_boolean_neg(int32_t* pC, int32_t *pA);

#define int_masking_boolean_not DILITHIUM_NAMESPACE(int_masking_boolean_not)
void int_masking_boolean_not(int32_t* pC, int32_t *pA);

#define int_masking_boolean_lshift DILITHIUM_NAMESPACE(int_masking_boolean_lshift)
void int_masking_boolean_lshift(int32_t* pC, int32_t *pA, int32_t shift);

#define int_masking_boolean_rshift DILITHIUM_NAMESPACE(int_masking_boolean_rshift)
void int_masking_boolean_rshift(int32_t* pC, int32_t *pA, int32_t shift);

#define int_masking_boolean_and DILITHIUM_NAMESPACE(int_masking_boolean_and)
void int_masking_boolean_and(int32_t*pC, int32_t *pA, int32_t *pB,pMsm pMsx);

#define int_masking_boolean_add DILITHIUM_NAMESPACE(int_masking_boolean_add)
void int_masking_boolean_add(int32_t*pC, int32_t *pA, int32_t *pB,pMtM *pMx);

#define int_masking_boolean_unprotected_generate DILITHIUM_NAMESPACE(int_masking_boolean_unprotected_generate)
void int_masking_boolean_unprotected_generate(int32_t* pC, int32_t a);

#define int_masking_boolean_unprotected_recombine DILITHIUM_NAMESPACE(int_masking_boolean_unprotected_recombine)
int32_t int_masking_boolean_unprotected_recombine(int32_t* pA);

#define int_masking_arithmetic_add DILITHIUM_NAMESPACE(int_masking_arithmetic_add)
void int_masking_arithmetic_add(int32_t* pC, int32_t* pA, int32_t* pB);

#define int_masking_arithmetic_generate DILITHIUM_NAMESPACE(int_masking_arithmetic_generate)
void int_masking_arithmetic_generate(int32_t* pC, int32_t a);

#define int_masking_arithmetic_unprotected_recombine DILITHIUM_NAMESPACE(int_masking_arithmetic_unprotected_recombine)
int32_t int_masking_arithmetic_unprotected_recombine(int32_t* pR);

#define int_masking_arithmetic_to_boolean_convert DILITHIUM_NAMESPACE(int_masking_arithmetic_to_boolean_convert)
void int_masking_arithmetic_to_boolean_convert(int32_t*pC, int32_t *pA,pMtL*  pMR);

#define int_masking_boolean_to_arithmetic_convert DILITHIUM_NAMESPACE(int_masking_boolean_to_arithmetic_convert)
void int_masking_boolean_to_arithmetic_convert(int32_t* pC, int32_t *pA);
