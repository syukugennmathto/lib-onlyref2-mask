...
void pack_pk(uint8_t pk[CRYPTO_PUBLICKEYBYTES],uint8_t rho[CRYPTO_PUBLICKEYBYTES], const polyveck *t1);
...
#define packing_sig DILITHIUM_NAMESPACE(packing_sig)
...
#define unpacking_sig DILITHIUM_NAMESPACE(unpacking_sig)
int unpacking_sig(
               uint8_t c[SEEDBYTES],
               polyvecl *z,
               polyveck *h,
